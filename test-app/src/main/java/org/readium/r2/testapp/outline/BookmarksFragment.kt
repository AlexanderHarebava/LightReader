...
class BookmarkAdapter(
    ...
    inner class ViewHolder(val binding: ItemRecycleBookmarkBinding) : RecyclerView.ViewHolder(
        ...
        fun bind(bookmark: Bookmark) {
            ...
            val totalProgression = bookmark.locator.locations.totalProgression

            val percent = ((totalProgression ?: 0.0) * 100)
                .roundToInt()
                .coerceIn(0, 100)

            binding.bookmarkProgression.text =
                binding.root.context.getString(R.string.through_resource, percent)
